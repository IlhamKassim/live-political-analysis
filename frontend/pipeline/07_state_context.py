...
Sources (curated, verified 2026-07-04, updated 2026-08-02 via web research — see AGENT_LOG):
  • MB/KM/Premier per state incl. the Dec-2025 Perlis change and Sabah's Nov-2025
    re-mandate. Johor: Onn Hafiz re-mandated at PRN 11 Jul 2026 (no longer
    caretaker; sworn 12 Jul, EXCO 18 Jul, first sitting date TBD → `sat`).
    N9: after PRN 1 Aug 2026 (BN 18 + PN 7), **Ismail Lasim** (UMNO, Juasseh
    5_N.15 winner) was sworn in as MB on 2 Aug 2026 at Istana Besar Seri
    Menanti (Astro Awani/Utusan/Buletin TV3; en-wiki 2026 N9 election page:
    appointed by Tuanku Muhriz). First sitting date TBD → `sat`.
...
MB = {
    "Johor":           {"name": "Onn Hafiz Ghazi", "title": "MB", "party": "UMNO", "coalition": "BN", "since": "2022", "caretaker": False},
    ...
    "Negeri Sembilan": {"name": "Ismail Lasim", "title": "MB", "party": "UMNO", "coalition": "BN", "since": "2026", "caretaker": False},
...
CLOCK = {
    ...
    "Johor":           {"last": "2026-07-11", "sat": None, "dissolve_by": None, "next": None},
    ...
    "Negeri Sembilan": {"last": "2026-08-01", "sat": None, "dissolve_by": None, "next": None},
...
def main():
    ...
    out = {"checked": "2026-08-02", "parlimen": CLOCK["parlimen"], "states": {}}
    for st in states:
        entry = {}
        if st in MB:
            entry["gov"] = MB[st]
